                        ...
                        <div id="main-col" class="col-b">
                            ...
                            <section class="masonry-wrapper">
                                <div id="masonry-container" class="transitions-enabled centered clearfix masonry">
                                    <!-- Blog Alanı -->
                                    <?php if($blogLists['blogsLists']): ?>
                                    <?php foreach($blogLists['blogsLists'] AS $Blogs): ?>
                                    <article class="masonry-box col-2 masonry-brick">
                                        <div class="entry-thumb">
                                            <a href="<?php echo site_url($Blogs->postseoname); ?>"><img class="kp-hover" src="<?php echo base_url( 'assets/nintweb/blogsphoto/' . getPhotoParser( $Blogs ) ); ?>" alt="" /></a>
                                        </div><!--kp-thumb-->
                                        <div class="entry-content">
                                            <h5 class="entry-title"><a href="<?php echo site_url($Blogs->postseoname); ?>"><?php echo $Blogs->postitle; ?></a></h5>
                                            <div class="info-meta">
                                                <i class="icon-user-md"></i>
                                                <span class="entry-meta"><?php echo _nint( 'Ekleyen: ' ); ?>&nbsp;</span>
                                                <a href="#" class="entry-author"><?php echo $Blogs->username; ?></a>
                                                <span class="entry-meta"><?php echo _nint( 'Tarih: ' ); ?>&nbsp;</span>
                                                <span class="entry-date"><?php echo getTimeToDate( $Blogs->postdate ); ?></span>
                                            </div><!--info-meta-->
                                            <p>g</p>
                                            <a class="learn-more" href="<?php echo site_url($Blogs->postseoname); ?>"><?php echo _nint( 'Devamını Oku' ); ?> &raquo;</a>
                                        </div><!--entry-content-->
                                    </article>
                                    <?php endforeach; ?>
                                    <?php else: ?>
                                    <div class="pagination clearfix">
                                       <h2 class="text-center text-red"><?php echo _nint( 'Henüz Blog Yazısı Eklenmemiş.' ); ?></h2> 
                                    </div>                                    
                                    <?php endif; ?>
                                    <!-- ./ end Blog Alanı -->                        
                                </div><!--masonry-container-->
                            </section><!--masonry-wrapper-->
                            <div class="kp-divider-1"></div>
                            <div class="pagination clearfix">
                                <ul class="clearfix">
                                    <li class="current">
                                       <?php echo $blogLists['blogsLink']; ?> 
                                    </li>                                    
                                </ul>
                            </div><!--pagination-->
                        </div><!--main-col-->

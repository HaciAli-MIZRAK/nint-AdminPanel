        <form action="<?php echo base_url('recordscp/newusersaddsrecordscp'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-9">
                        <div class="box box-success box-solid" style="border-radius: 0; border: none;">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-pencil fa-lg"></i> <?php echo _nint( 'Yeni Kullanıcı Ekle' ); ?></h3>
                            ...
                            <div class="box-body" style="border-radius: 0; border: none;">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" class="form-control" id="" placeholder="<?php echo _nint( 'Kullanıcı Adı Girin' ); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for=""><?php echo _nint( 'E-posta Adresi' ); ?></label>
                                        <input type="text" name="useremail" class="form-control" id="" placeholder="<?php echo _nint( 'E-posta Adresi Girin' ); ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for=""><?php echo _nint( 'Kullanıcı Şifresi' ); ?></label>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <select name="_userroles" class="form-control">
                                                <option value=""><?php echo _nint( 'Standart Kullanıcı' ); ?></option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <select name="parentid" class="form-control">
                                                ...
                                                <?php foreach($userShowLists AS $userLists): ?>
                                                    <option value="<?php echo $userLists->userid; ?>"><?php echo $userLists->username; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <select name="_notification" class="form-control">
                                                <option value="0"><?php echo _nint( 'Kullanıcı Bildirimi' ); ?></option>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <select name="_scannernotification" class="form-control">
                                                <option value="0"><?php echo _nint( 'Tarayıcı Bildirimi Yok' ); ?></option>

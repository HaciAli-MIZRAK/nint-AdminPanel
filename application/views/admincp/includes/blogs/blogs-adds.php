        <form action="<?php echo base_url('recordscp/newblogsaddsrecordscp'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-9">
                        <div class="box box-success box-solid" style="border-radius: 0; border: none;">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-plus fa-lg"></i> <?php echo _nint( 'Yeni Blog Ekle' ); ?></h3>
                            </div><!-- /.box-header -->
                            <div class="box-body" style="border-radius: 0; border: none;">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="postitle" class="form-control" id="" placeholder="<?php echo _nint( 'Blog Title Girin' ); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for=""><?php echo _nint( 'Blog İçeriği' ); ?></label>
                                        <textarea type="text" name="postcontent" class="textarea form-control" rows="10" id="CKeditor" placeholder="<?php echo _nint( 'Blog İçeriği Girin' ); ?>"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success box-solid" style="border-radius: 0; border: none;">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-12">
                                        <h5 class="fa-black"><strong><?php echo _nint( 'Blog Dili' ); ?></strong></h5>
                                        <div class="form-group">
...
<!--                        <div class="col-md-12">
                            ...
                            <div class="box box-success box-solid" style="border-radius: 0; border: none;">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo _nint( 'Blog Özellikleri' ); ?></h3>
                                </div> /.box-header 
                                <div class="box-body">
                                    <div class="col-xs-12">
